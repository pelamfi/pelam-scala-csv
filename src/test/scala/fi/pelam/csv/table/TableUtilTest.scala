...
class TableUtilTest {
  ...
  def testRenumberDown: Unit = {
    assertEquals("List(StringCell with value '4b' at Row 2, Column B (1), " +
      ...
      renumberDown(List(cell4b, cell3c), (cell2b.cellKey, cell3c.cellKey)).toList.toString())
  }
  ...
  def testRenumberDown2Cols: Unit = {
    assertEquals("List(StringCell with value '4b' at Row 2, Column B (1), " +
      ...
      ")",
      renumberDown(List(cell4b, cell3c, cell4c), (cell2b.cellKey, cell3d.cellKey)).toList.toString())
  }
}